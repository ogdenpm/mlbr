...
static const char *git_ver =
    GIT_APPNAME " " GIT_PORT " - port " GIT_VERSION " " BUILD " (C)" GIT_YEAR " Mark Ogden";
#else
...
git_detail_t git_detail = { GIT_APPNAME, GIT_VERSION, GIT_SHA1 DIRTY, GIT_CTIME };
